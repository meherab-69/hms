...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT user_id, firstname, lastname, password FROM receptionists WHERE user_id = ?");
    if (!$stmt) {
            ...
            <div class="system-card">
                <div class="system-row">
                    ...
                    <div class="system-info">
                        <h1 class="system-title">Receptionist Login</h1>
                        <p class="system-subtitle">Please enter your credentials to access the receptionist portal</p>
