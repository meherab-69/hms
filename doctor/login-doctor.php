...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $user_id = trim($_POST['doctor_id']);
    $password = trim($_POST['password']);

    $stmt = $conn->prepare("SELECT doctor_id, firstname, lastname, speciality, qualification, user_type, password FROM doctors WHERE doctor_id = ?");
    if (!$stmt) {
            ...
            <div class="system-card">
                <div class="system-row">
                    ...
                    <div class="system-info">
                        <h1 class="system-title">Doctor Login</h1>
                        <p class="system-subtitle">Please enter your credentials to access the doctor portal</p>
